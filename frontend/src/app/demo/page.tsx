    ...
    <div className="flex flex-col items-center justify-center h-full gap-8">
      ...
      {done ? (
        <button
          ...
          className="flex items-center gap-3 px-8 py-4 rounded-lg text-lg font-medium bg-status-safe text-canvas hover:opacity-90 transition-opacity min-h-11"
        >
        ...
        <button
          key="stop"
          onClick={stop}
          className="flex items-center gap-3 px-8 py-4 rounded-lg text-lg font-medium border border-status-critical text-status-critical hover:bg-elevated transition-colors min-h-11"
        >
